"""
Function to play the Raindrops challenge.
"""
...
def convert(number):
    ...
    param: number - int: the number that will be tested
    return result_final - str: converting the number into raindrop sounds
    """
