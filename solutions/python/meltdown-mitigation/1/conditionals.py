...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    product_temperature_and_neutrons = temperature * neutrons_emitted

    if temperature < 800 and neutrons_emitted > 500 and product_temperature_and_neutrons < 500000:
        return True
    return False
